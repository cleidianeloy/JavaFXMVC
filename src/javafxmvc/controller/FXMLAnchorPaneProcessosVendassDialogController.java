 ...
 * @author Cleid
 */
public class FXMLAnchorPaneProcessosVendassDialogController implements Initializable {
    ...
    public void handleButtonAdicionar() {
        ...
        if (comboBoxVendaProduto.getSelectionModel().getSelectedItem() != null) {
            ...
            if (produto.getQuantidade() >= Integer.parseInt(textFieldVendaItemDeVendaQuantidade.getText())) {
                ...
                alert.setContentText("Não existe a quantidade de produtos disponiveis no estoque!");
                alert.show();
            }
        }
    }
    ...
    public void handleButtonRemover() {
        ...
        if (tableViewItensDeVenda.getSelectionModel().getSelectedItem() != null) {
            ...
            Alert alert = new Alert(Alert.AlertType.ERROR);
            alert.setHeaderText("Problemas em remover um item de venda");
            alert.setContentText("Nenhum item foi selecionado!");
            alert.show();
        }
    }
